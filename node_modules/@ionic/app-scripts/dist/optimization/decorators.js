...
function addPureAnnotation(filePath, originalFileContent, ionicAngularDir, angularDir, srcDir, magicString) {
...
function purgeTranspiledDecorators(filePath, originalFileContent, ionicAngularDir, angularDir, srcDir, magicString) {
...
function purgeStaticFieldDecorators(filePath, originalFileContent, ionicAngularDir, angularDir, srcDir, magicString) {
    if (filePath.indexOf(angularDir) >= 0 || filePath.indexOf(ionicAngularDir) >= 0 || filePath.indexOf(srcDir) >= 0) {
...
function purgeStaticCtorFields(filePath, originalFileContent, ionicAngularDir, angularDir, srcDir, magicString) {
